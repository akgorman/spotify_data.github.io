...
```{r}
bpm_histogram <- ggplot(spotify2023_df, aes(x = bpm, fill = ..count..)) +
  geom_histogram(
    binwidth = 5,  
    color = "pink", 
    alpha = 0.8
  ...
  labs(
    title = "Distribution of Song Count by BPM",
    subtitle = "Analyzing the frequency of different tempos",
...
interactive_bpm_histogram <- ggplotly(bpm_histogram, tooltip = c("x", "fill"))
