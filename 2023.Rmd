...
**Data Wrapped: The Top Chart-Toppers of 2023**
...
ggplot(top_artists_danceability, aes(x = reorder(artist, danceable_songs), y = danceable_songs, fill = danceable_songs)) +
  ...
  scale_fill_gradient(low = "darkgreen", high = "lightgreen") +  # Green gradient added here
  theme_minimal() +
  theme(legend.position = "none")
```

*Artists with the Most Songs by Count*
```{r}
